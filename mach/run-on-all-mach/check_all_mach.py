...
if __name__ == "__main__":
    ...
    for machId in test_machs:
        ...
        if not is_new(machId):
            counter += 1
            checked_counter += 1
            print("[{}/{}][{}] Already checked".format(counter, 2000, machId + ".txt"))
            continue
        ############
        ...
        bash_code = 'grep -a -h "ERROR: \|WARN :" /home/mach/mach/logs/* | cut -d ":" -f 2,3,4 --complement | sort | uniq -c | grep -a -v "MachFsBasedUpdater: +\| WINFO"'
        input_field.send_keys(bash_code)
        time.sleep(1)  # Sometimes there is an error for clicking enter too fast
        ...
        with open(path_file, "w", encoding='utf-8') as file:
            ...
            if len(outputs) == 1:
                print("[{}/{}][{}] Processing successful".format(counter, 2000, machId))
